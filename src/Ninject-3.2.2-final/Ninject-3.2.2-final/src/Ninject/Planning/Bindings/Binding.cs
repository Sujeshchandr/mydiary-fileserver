...
namespace Ninject.Planning.Bindings
{
    ...
    public class Binding : IBinding
    {
        ...
        #region Implemented Properties OF IBinding Interface
        ...
        #endregion Implemented Properties OF IBinding Interface

        #region Implemented Properties OF IBindingConfiguration Interface
        ...
        #endregion Implemented Properties OF IBindingConfiguration Interface

        #endregion PUBLIC POPERTIES

        #region PUBLIC METHODS

        #region Implemented methods OF IBindingConfiguration Interface
        ...
        #endregion Implemented methods OF IBindingConfiguration Interface
